...
| 104 | 二叉树的最大深度              |               [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/104-maxDepth/maxDepth.go)               |  0.31%   |     简单     |        二叉树, 递归        |
| 100 | 相同的树                  |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/100-isSameTree/isSameTree.go)             | 100.00%  |     简单     |      二叉树, 深度优先搜索      |
| 226 | 翻转二叉树                 |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/226-invertTree/invertTree.go)             | 100.00%  |     简单     |      二叉树, 广度优先搜索      |
| 101 | 对称二叉树                 |            [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/101-isSymmetric/isSymmetric.go)            |  0.78%   |     简单     |      二叉树, 深度优先搜索      |
| 105 | 从前序与中序遍历序列构造二叉树       |              [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/105-buildTree/buildTree.go)              |  9.04%   |     中等     |     二叉树, 哈希表, 分治      |
| 106 | 从中序与后序遍历序列构造二叉树       |              [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/106-buildTree/buildTree.go)              |  6.67%   |     中等     |     二叉树, 哈希表, 数组      |
| 117 | 填充每个节点的下一个右侧节点指针 II   |                [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/117-connect/connect.go)                |  72.26%  |     中等     |    二叉树, 链表, 广度优先搜索    |
| 114 | 二叉树展开为链表              |                [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/114-flatten/flatten.go)                |  0.62%   |     中等     |    二叉树, 链表, 深度优先搜索    |
| 112 | 路径总和                  |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/112-hasPathSum/hasPathSum.go)             |  68.95%  |     简单     |  二叉树, 广度优先搜索, 深度优先搜索  |
| 129 | 求根节点到叶节点数字之和          |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/129-sumNumbers/sumNumbers.go)             |  30.19%  |     中等     |      二叉树, 深度优先搜索      |
| 173 | 二叉搜索树迭代器              |            [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/173-BSTIterator/BSTIterator.go)            |  54.59%  |     中等     |    二叉树, 二叉搜索树, 迭代器    |
| 222 | 完全二叉树的节点个数            |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/222-countNodes/countNodes.go)             |  63.85%  |     简单     |       二叉树, 二分查找       |
| 236 | 二叉树的最近公共祖先            |      [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/236-lowestComAncestor/lowestComAncestor.go)      |  64.96%  |     中等     |      二叉树, 深度优先搜索      |
| 199 | 二叉树的右视图               |          [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/199-rightSideView/rightSideView.go)          | 100.00%  |     中等     |  二叉树, 深度优先搜索,广度优先搜索   |
| 637 | 二叉树的层平均值              |        [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/637-averageOfLevels/averageOfLevels.go)        |  77.59%  |     简单     |  二叉树, 深度优先搜索,广度优先搜索   |
| 102 | 二叉树的层序遍历              |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/102-levelOrder/levelOrder.go)             | 100.00%  |     中等     |      二叉树,广度优先搜索       |
| 103 | 二叉树的锯齿形层序遍历           |       [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/103-zigzagLevelOrder/zigzagLevelOrder.go)       |  11.44%  |     中等     |      二叉树,广度优先搜索       |
| 530 | 二叉搜索树的最小绝对差           |   [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/530-getMinimumDifference/getMinimumDifference.go)   |  83.57%  |     简单     |       二叉树,二叉搜索树       |
| 230 | 二叉搜索树中第 K 小的元素        |            [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/230-kthSmallest/kthSmallest.go)            |  83.63%  |     中等     |   二叉树,二叉搜索树,深度优先搜索    |
| 98  | 验证二叉搜索树               |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/98-isValidBST/isValidBST.go)              |  6.02%   |     中等     |   二叉树,二叉搜索树,深度优先搜索    |
| 200 | 岛屿数量                  |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/200-numIslands/numIslands.go)             |  30.13%  |     中等     | 数组,深度优先搜索,广度优先搜索,并查集  |
| 130 | 被围绕的区域                |                  [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/130-solve/solve.go)                  |  30.13%  |     中等     |  数组,深度优先搜索,广度优先搜索,矩阵  |
| 133 | 克隆图                   |             [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/133-cloneGraph/cloneGraph.go)             |  30.13%  |     中等     |  图,深度优先搜索,广度优先搜索,哈希表  |
...
| 23  | 合并 K 个升序链表            |            [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/23-mergeKLists/mergeKLists.go)             |  83.10%  |     困难     |  链表,分治,堆(优先队列),归并排序   |
| 53  | 最大子数组和                |            [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/53-maxSubArray/maxSubArray.go)             |  23.08%  |     中等     |      数组,分治,动态规划       |
| 918 | 环形子数组的最大和             | [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/918-maxSubarraySumCircular/maxSubarraySumCircular.go) |  5.54%   |     中等     |  数组,队列,分治,动态规划,单调队列   |
| 35  | 搜索插入位置                |           [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/35-searchInsert/searchInsert.go)            | 100.00%  |     简单     |        数组,二分查找        |
| 74  | 搜索二维矩阵                |           [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/74-searchMatrix/searchMatrix.go)            | 100.00%  |     中等     |      数组,二分查找,矩阵       |
| 162 | 寻找峰值                  |        [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/162-findPeakElement/findPeakElement.go)        |  0.13%   |     中等     |        数组,二分查找        |
| 33  | 搜索旋转排序数组              |                 [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/33-search/search.go)                  |  0.79%   |     中等     |        数组,二分查找        |
| 34  | 在排序数组中查找元素的第一个和最后一个位置 |            [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/34-searchRange/searchRange.go)             |  0.79%   |     中等     |        数组,二分查找        |
| 153 | 寻找旋转排序数组中的最小值         |                [Go](https://github.com/Gavin16/go-leetcode/blob/main/classic/153-findMin/findMin.go)                | 100.00%  |     中等     |        数组,二分查找        |
